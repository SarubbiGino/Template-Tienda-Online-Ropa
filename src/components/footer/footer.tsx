...
import logo from '../../img/OVlogoB.png'


function header() {
  return (
    <div>
      <footer className="p-4 bg-[#181818] sm:p-6">
        <div className="md:flex md:justify-between">
          <div className="grid grid-cols-2 sm:grid-cols-4 items-center small:grid-cols-1 sm:gap-2 small:gap-20 justify-center content-center  ">
            <a className="flex items-center justify-center">
              <img src={logo} className="h-64 mr-3" alt="FlowBite Logo" />
            </a>
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Productos</h2>
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a href="https://www.instagram.com/pacobarel/" className="hover:text-blue-500 ">Gorras OverLife</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/pacobarel/" className="hover:text-blue-500">Remeras OverLife</a>
                </li>
              </ul>
            </div>
            <div>
              <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Venta por mayor</h2>
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a href="https://www.instagram.com/pacobarel/" className="hover:text-blue-500">OverLife Instagram</a>
                </li>
                <li>
                  <a href="https://www.instagram.com/pacobarel/" className="hover:text-blue-500">OverLife WhatsApp</a>
                </li>
              </ul>
            </div>
            <div>
              <button className="px-4 py-2 font-semibold text-white transition-colors duration-200 transform border border-white w-40 rounded-md hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Iniciar Sesion</button>
            </div>
          </div>
        </div>
        <hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
        <div className="sm:flex sm:items-center sm:justify-between  ">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:text-blue-500">OverLife</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0 small:items-center small:justify-center">
